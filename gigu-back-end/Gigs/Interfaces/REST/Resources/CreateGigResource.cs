...
namespace Gigs.Interfaces.REST.Resources
{
    public class CreateGigResource
    {
        ...
        public List<string> Tags { get; set; } = new(); // Inicializado por defecto
        ...
        public int DeliveryDays { get; set; } = 7; // Valor por defecto

        public bool IsResponsive { get; set; } = true; // Valor por defecto
        ...
        public List<string> ExtraFeatures { get; set; } = new(); // Inicializado por defecto
